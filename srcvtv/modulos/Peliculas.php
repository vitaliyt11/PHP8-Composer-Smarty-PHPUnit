...
/**
 * Clase Peliculas.
 * Gestiona el listado y la comprobación de la existencia de las películas en la base de datos.
 *
...
/**
 * Clase Peliculas.
 * Implementa la interfaz IListableVTV para gestionar el listado y comprobación de existencia de las películas en la base de datos.
 */
class Peliculas implements IListableVTV {

    /**
     * Función para listar todas las películas que existen en la base de datos.
     * 
     * @param PDO $pdo Objeto PDO con la conexión a la base de datos.
     * @return DBResult|array Array de objetos Pelicula con los datos extraídos o enumeración DBResult en caso de error/vacío.
     */
    ...
    /**
     * Función para comprobar si existe una película mediante su ID en la base de datos.
     * 
     * @param PDO $pdo Objeto PDO con la conexión a la base de datos.
     * @param int $id Identificador de la película a comprobar.
    ...
    public static function existe(PDO $pdo, int $id): DBResult | int{
        ...
        $sql = "SELECT titulo FROM peliculas WHERE id=:id";
        //Variables auxiliares
        $resultado = false;
        $resultadoSQL = false;
        ...
        if ($resultadoSQL === false) {
            ...
            $resultado = 1; // Devuelve el 1 debido a que existe la película
        }
        return $resultado;
    }
}